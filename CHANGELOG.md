...
- Действия с бюджетом (`increase_budget`, `decrease_budget`) явно ограничены уровнем адсета и отклоняются на уровне кампании: при Campaign Budget Optimization бюджет принадлежит кампании, и запрос к адсету Meta отклоняет. Форма создания правила не предлагает эти действия для кампании.
