...
- Точка входа Facebook в Ads Manager приведена к паттерну Linear `New project`: компактное действие `+ Connect Facebook` в шапке открывает существующий выбор способа подключения, а пустое состояние сохраняет заметный CTA.
