...
- В новом Ads Manager добавлен минимальный Facebook OAuth flow: кнопка «Подключить кабинеты» в пустом состоянии, меню `…` для нового профиля или одноразовой ссылки, выбор обнаруженных кабинетов и импорт без включения автоправил.
