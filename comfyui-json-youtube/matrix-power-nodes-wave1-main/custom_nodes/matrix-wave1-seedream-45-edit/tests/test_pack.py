...
class PackWiringTests(unittest.TestCase):
    def test_declared_nodes_are_registered(self):
        ...
        for node_id, module in {'MATRIX_Wave1Seedream45Edit': 'matrix_wave1seedream45edit'}.items():
    ...
    def test_route_widget_order_is_published(self):
        expected = {'MATRIX_Wave1Seedream45Edit': ['prompt', 'images', 'size', 'width', 'height']}
        for node_id, route_names in expected.items():
            module = {'MATRIX_Wave1Seedream45Edit': 'matrix_wave1seedream45edit'}[node_id]
