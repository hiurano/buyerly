"""Compiled declaration for MATRIX_Wave1Seedream45Edit; regenerate instead of hand-editing."""
from __future__ import annotations

NODE_ID = 'MATRIX_Wave1Seedream45Edit'
PROVIDER = 'wavespeed'
ROUTE = 'bytedance/seedream-v4.5/edit'
ROUTES = ('bytedance/seedream-v4.5/edit',)
SCHEMA_WIDGETS = {
...
FORMULA_DEFAULTS = {'bytedance/seedream-v4.5/edit': {}}
ROUTE_FIELD_NAMES = tuple(SCHEMA_WIDGETS)
FRAMEWORK_FIELD_NAMES = ('live',)

class MATRIXWave1Seedream45Edit:
    @classmethod
    def INPUT_TYPES(cls):
        return {
            "required": {
    ...
    DESCRIPTION = 'Generated from bytedance/seedream-v4.5/edit; dry run by default.'
...
NODE_CLASS_MAPPINGS = {NODE_ID: MATRIXWave1Seedream45Edit}
NODE_DISPLAY_NAME_MAPPINGS = {NODE_ID: 'MATRIX POWER NODES - Seedream 4.5 Edit'}
