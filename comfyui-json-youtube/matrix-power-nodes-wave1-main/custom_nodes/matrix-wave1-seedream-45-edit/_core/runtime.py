...
RUNTIME_CONTRACTS = {'wavespeed': {'auth': 'bearer',
               ...
               'provider_fact': {'fetched': '2026-08-04T12:00:38+02:00',
                                 ...
                                 'provider': 'wavespeed',
                                 'routes': {'bytedance/seedream-v4.5/edit': {'api_path': '/api/v3/bytedance/seedream-v4.5/edit',
                                                                             'fields': {'enable_base64_output': {'description': 'If '
                                                                                                                                'set '
                                                                                                                                'to '
                                                                                                                                '`true`, '
                                                                                                                                'the '
                                                                             ...
                                                                             'required': ['prompt',
                                                                                          'images'],
                                                                             'type': 'image-to-image'}}},
               'route_max_costs': {'bytedance/seedream-v4.5/edit': 0.04}}}
_PACK_ID = '7af84dc51e637c43'
SEMANTIC_RUNTIME_IDS = {'MATRIX_Wave1Seedream45Edit': 'a028348372c0d34b501107d6757b5598bee97b9b1e766a5b1428866499e386c6'}
