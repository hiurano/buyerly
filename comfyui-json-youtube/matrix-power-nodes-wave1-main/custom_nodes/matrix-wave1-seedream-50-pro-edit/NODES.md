...
## MATRIX POWER NODES - Seedream 5.0 Pro Edit

- Node ID: `MATRIX_Wave1Seedream50ProEdit`
- Provider route: `bytedance/seedream-v5.0-pro/edit`
- Base price: `$0.045`
- Price formula: `{"total_price": (resolution = "2k" ? 90000 : 45000) + 3000 * $max([0, $count(images) - 1])}`
- Maximum contract cost: `$0.117000`
...
- `aspect_ratio` — The aspect ratio of the generated image. Leave empty to automatically use the closest supported aspect ratio based on the first input image. (optional; string; allowed: `provider default (omit)`, `1:1`, `1:2`, `2:1`, `1:3`, `3:1`, `2:3`, `3:2`, `3:4`, `4:3`, `4:5`, `5:4`, `9:16`, `16:9`, `9:21`, `21:9`).
