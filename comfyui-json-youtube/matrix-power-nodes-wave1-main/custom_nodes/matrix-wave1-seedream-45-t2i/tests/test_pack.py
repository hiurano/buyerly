...
class PackWiringTests(unittest.TestCase):
    def test_declared_nodes_are_registered(self):
        ...
        for node_id, module in {'MATRIX_Wave1Seedream45T2i': 'matrix_wave1seedream45t2i'}.items():
    ...
    def test_route_widget_order_is_published(self):
        expected = {'MATRIX_Wave1Seedream45T2i': ['prompt', 'size', 'width', 'height']}
        for node_id, route_names in expected.items():
            module = {'MATRIX_Wave1Seedream45T2i': 'matrix_wave1seedream45t2i'}[node_id]
