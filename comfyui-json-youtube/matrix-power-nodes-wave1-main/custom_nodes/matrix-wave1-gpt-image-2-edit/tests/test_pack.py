...
class PackWiringTests(unittest.TestCase):
    def test_declared_nodes_are_registered(self):
        ...
        for node_id, module in {'MATRIX_Wave1GptImage2Edit': 'matrix_wave1gptimage2edit'}.items():
    ...
    def test_route_widget_order_is_published(self):
        expected = {'MATRIX_Wave1GptImage2Edit': ['prompt', 'images', 'aspect_ratio', 'output_format', 'quality', 'resolution']}
        for node_id, route_names in expected.items():
            module = {'MATRIX_Wave1GptImage2Edit': 'matrix_wave1gptimage2edit'}[node_id]
