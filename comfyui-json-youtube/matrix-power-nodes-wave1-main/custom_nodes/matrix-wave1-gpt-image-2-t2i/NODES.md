...
## MATRIX POWER NODES - GPT Image 2

- Node ID: `MATRIX_Wave1GptImage2T2i`
- Provider route: `openai/gpt-image-2/text-to-image`
- Base price: `$0.06`
- Price formula: `{"total_price": ((quality = "low") ? (resolution = "4k" ? 30000 : (resolution = "2k" ? 20000 : 10000)) : ((quality = "high") ? (resolution = "4k" ? 720000 : (resolution = "2k" ? 400000 : 220000)) : (resolution = "4k" ? 180000 : (resolution = "2k" ? 100000 : 60000))))}`
- Maximum contract cost: `$0.720000`

### Widgets

- `prompt` — The positive prompt for the generation. (required; string).
- `aspect_ratio` — The aspect ratio of the generated image. (optional; string; allowed: `provider default (omit)`, `1:1`, `1:2`, `2:1`, `1:3`, `3:1`, `2:3`, `3:2`, `3:4`, `4:3`, `4:5`, `5:4`, `9:16`, `16:9`, `9:21`, `21:9`).
