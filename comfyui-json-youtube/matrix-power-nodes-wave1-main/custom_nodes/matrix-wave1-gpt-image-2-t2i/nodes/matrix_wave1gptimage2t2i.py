"""Compiled declaration for MATRIX_Wave1GptImage2T2i; regenerate instead of hand-editing."""
from __future__ import annotations

NODE_ID = 'MATRIX_Wave1GptImage2T2i'
PROVIDER = 'wavespeed'
ROUTE = 'openai/gpt-image-2/text-to-image'
ROUTES = ('openai/gpt-image-2/text-to-image',)
SCHEMA_WIDGETS = {
    'prompt': ('STRING', {'multiline': True, 'tooltip': 'The positive prompt for the generation.'}),
    'aspect_ratio': (['provider default (omit)', '1:1', '1:2', '2:1', '1:3', '3:1', '2:3', '3:2', '3:4', '4:3', '4:5', '5:4', '9:16', '16:9', '9:21', '21:9'], {'default': 'provider default (omit)', 'tooltip': 'The aspect ratio of the generated image.'}),
...
FORMULA_DEFAULTS = {'openai/gpt-image-2/text-to-image': {'quality': 'medium', 'resolution': '1k'}}
ROUTE_FIELD_NAMES = tuple(SCHEMA_WIDGETS)
FRAMEWORK_FIELD_NAMES = ('live',)

class MATRIXWave1GptImage2T2i:
    @classmethod
    def INPUT_TYPES(cls):
        return {
            "required": {
    ...
    DESCRIPTION = 'Generated from openai/gpt-image-2/text-to-image; dry run by default.'
...
NODE_CLASS_MAPPINGS = {NODE_ID: MATRIXWave1GptImage2T2i}
NODE_DISPLAY_NAME_MAPPINGS = {NODE_ID: 'MATRIX POWER NODES - GPT Image 2'}
