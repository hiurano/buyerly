"""Compiled declaration for MATRIX_Wave1NanoBananaProEdit; regenerate instead of hand-editing."""
from __future__ import annotations

NODE_ID = 'MATRIX_Wave1NanoBananaProEdit'
PROVIDER = 'wavespeed'
ROUTE = 'google/nano-banana-pro/edit'
ROUTES = ('google/nano-banana-pro/edit',)
SCHEMA_WIDGETS = {
...
FORMULA_DEFAULTS = {'google/nano-banana-pro/edit': {'resolution': '1k'}}
ROUTE_FIELD_NAMES = tuple(SCHEMA_WIDGETS)
FRAMEWORK_FIELD_NAMES = ('live',)

class MATRIXWave1NanoBananaProEdit:
    @classmethod
    def INPUT_TYPES(cls):
        return {
            "required": {
    ...
    DESCRIPTION = 'Generated from google/nano-banana-pro/edit; dry run by default.'
...
NODE_CLASS_MAPPINGS = {NODE_ID: MATRIXWave1NanoBananaProEdit}
NODE_DISPLAY_NAME_MAPPINGS = {NODE_ID: 'MATRIX POWER NODES - Nano Banana Pro Edit'}
