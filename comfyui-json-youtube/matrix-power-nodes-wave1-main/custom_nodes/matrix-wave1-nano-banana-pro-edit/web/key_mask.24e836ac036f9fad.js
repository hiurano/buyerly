...
const KEY_CONFIG = {"MATRIX_Wave1NanoBananaProEdit":{"intentHeader":"X-Matrix-Credential-Intent-V2","intentValue":"matrix-credentials-v2","provider":"wavespeed","route":"/matrix/credentials/v2/wavespeed/key"}};
const EXTENSION_NAME = "matrix.compiled.13aaac70cab52fee.key-mask.v5";
