"""Compiled declaration for MATRIX_Wave1NanoBanana2T2i; regenerate instead of hand-editing."""
from __future__ import annotations

NODE_ID = 'MATRIX_Wave1NanoBanana2T2i'
PROVIDER = 'wavespeed'
ROUTE = 'google/nano-banana-2/text-to-image'
ROUTES = ('google/nano-banana-2/text-to-image',)
SCHEMA_WIDGETS = {
...
FORMULA_DEFAULTS = {'google/nano-banana-2/text-to-image': {'enable_image_search': False, 'enable_web_search': False, 'resolution': '1k'}}
ROUTE_FIELD_NAMES = tuple(SCHEMA_WIDGETS)
FRAMEWORK_FIELD_NAMES = ('live',)

class MATRIXWave1NanoBanana2T2i:
    @classmethod
    def INPUT_TYPES(cls):
        return {
            "required": {
    ...
    DESCRIPTION = 'Generated from google/nano-banana-2/text-to-image; dry run by default.'
...
NODE_CLASS_MAPPINGS = {NODE_ID: MATRIXWave1NanoBanana2T2i}
NODE_DISPLAY_NAME_MAPPINGS = {NODE_ID: 'MATRIX POWER NODES - Nano Banana 2'}
