...
Новые изменения вносятся в соответствующий действующий документ. Не создавайте ещё одну сводку готовности или копию бэклога. Тесты выполняются только в GitHub Actions согласно [AGENTS.md](../AGENTS.md).
